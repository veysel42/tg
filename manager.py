...
def banner():
    ...
    print(f'   Version: 1.2 | Author: VeyselS0214{n}\n')
...
while True:
    ...
    if a == 1:
            ...
            if len(banned_accs) == 0:
                ...
                with open('vars.txt', 'wb') as k:
                    for a in accounts:
                        ...
                        pickle.dump([Phone], k)
                k.close()
                print(lg+'[i] Banlı Hesaplar Silindi'+n)
                input('\nAna Menüye Gitmek İçin ENTERe Bas...')
        ...
        f.close()
        i = 0
        print(f'{lg}[i] Silmek İçin Bir Hesap Seç\n')
        for acc in accs:
        ...
        try:
            # https://raw.githubusercontent.com/veysel42/tg/main/version.txt
            version = requests.get('https://raw.githubusercontent.com/veysel42/tg/main/version.txt')
        except:
        ...
        if float(version.text) > 1.1:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/veysel42/tg/main/add.py')
                os.system('curl -l -O https://raw.githubusercontent.com/veysel42/tg/main/manager.py')
            ...
            print(f'{lg}[i] Yazılım Güncel')
            input('Ana Menüye Gitmek İçin ENTERe Bas...')
    elif a == 5:
        clr()
        banner()
        exit()
